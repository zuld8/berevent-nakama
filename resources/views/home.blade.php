                ...
                <div class="space-y-3">
                    @foreach ($campaigns as $c)
                        ...
                        <a href="{{ route('campaign.show', $c->slug) }}"
                           class="group block overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm hover:shadow-md hover:border-teal-200 transition-all duration-200">
