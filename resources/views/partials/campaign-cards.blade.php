    ...
    <article class="relative overflow-hidden rounded-md border border-gray-200 bg-white shadow hover:shadow-md hover:border-sky-300 cursor-pointer">
        ...
        <div class="space-y-3 p-4">
            ...
            <a href="{{ route('campaign.show', $c->slug) }}"
               class="relative z-20 mt-3 inline-flex w-full items-center justify-center rounded-md bg-teal-500 px-4 py-2 text-sm font-semibold text-white shadow hover:bg-teal-600">
                Donasi Sekarang
            </a>
        </div>
    </article>
